...
angular.module('canhe.list', [])
  .controller('mylist', ['$rootScope', '$scope', function ($rootScope, $scope) {
    ...
    $scope.secondItem = 1;
    $scope.sortList = [
      {name: '分类一', id: 1}, {name: '分类一', id: 2}, {name: '分类一', id: 3}, {name: '分类一', id: 4}, {
        name: '分类一',
        id: 5
      }, {name: '分类一', id: 6}, {name: '分类一', id: 7}, {name: '分类一', id: 8}
    ]

    $scope.secondList = [
      {name: '五格餐盒', id: 1}, {name: '四格餐盒', id: 2}, {name: '三格餐盒', id: 3}, {name: '二格餐盒', id: 4}, {
        name: '一格餐盒',
        id: 5
      }, {name: '分类一', id: 6}, {name: '分类一', id: 7}, {name: '分类一', id: 9}, {name: '分类一', id: 8}, {name: '分类一', id: 10}
    ]
